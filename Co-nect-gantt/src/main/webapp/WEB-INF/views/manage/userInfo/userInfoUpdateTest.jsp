...
<body>
	<div class="container">
		...
		<form method="post" action="${pageContext.request.contextPath}/manage?fn=ADMIN_USERLIST_PROC" enctype="multipart/form-data">
			...
			<input type="text" value="${user.user_pic}" readonly="readonly">
			...
			<input type="password" id="user_pw" name="user_pw" value="${user.user_pw}" readonly="readonly">
			
			<label for="user_mail">이메일</label>
			<input type="email" id="user_mail" name="user_mail" value="${user.user_mail}" readonly="readonly">

			<label for="user_regdate">입사일</label> 
			<input type="date" id="user_regdate" name="user_regdate" value="${user.user_regdate}" readonly="readonly"> 
			
			<label for="user_rank">직급</label> 
			<select name="user_rank" id="user_rank" disabled="disabled">
			...
			<select name="user_fk_job_num" id="user_fk_job_num" disabled="disabled">
			...
			<select id="user_fk_dpart_num" name="user_fk_dpart_num" disabled="disabled">
			...
			<select id="user_fk_acc_authornum" name="user_fk_acc_authornum" disabled="disabled">
