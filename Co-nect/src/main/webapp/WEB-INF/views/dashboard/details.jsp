...
<div
        ...
        style="
        background-image: url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-proassets/img/profile-layout-header.jpg');
...
<div class="col-lg-11">
    <div style="margin-left: 3rem" class="card"> 
        ...
        <div class="form-group">
            <label for="proj_name">프로젝트 이름:</label><br>
        ...
        <div class="form-group">
            <label for="task_status">프로젝트 상태:</label><br>
        ...
        <div class="form-group">
            <label for="task_desc">프로젝트 중요도:</label><br>
