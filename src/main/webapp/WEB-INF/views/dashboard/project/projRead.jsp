...
<%--  <img--%>
<%--          src="../../../../asset/1_landing/co-nect%20logo%20+%20text%20(w).svg"--%>
<%--          alt="Logo"--%>
<%--          class="sidenav-logo"--%>
<%--  />--%>
<%--</div>--%>
...
<%--      <img--%>
<%--              src="../../../../asset/1_landing/co-nect%20logo%20+%20text%20(1E74B1).svg"--%>
...
<%--          <ul>--%>
<%--            <li style="list-style: none; text-align: center">--%>
<%--              <a class="nav-link" href="../../../../prototype/details.html">--%>
<%--                프로젝트 일정--%>
<%--              </a>--%>
<%--            </li>--%>
<%--          </ul>--%>
...
<c:forEach var="l" items="<%=getTaskList%>" >
${l.task_pk_num}
</c:forEach>
</body>
