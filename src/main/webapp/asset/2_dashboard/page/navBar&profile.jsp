...
<body>
	...
	<a href="${pageContext.request.contextPath}/landing?fn=MAIN"style="float:left; position:relative;">
	...
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				class="ms-1 font-weight-bold">(주)코난2조</span>
			</a>
		</div>
		...
		<div class="collapse navbar-collapse  w-auto h-auto"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link active"
					...
					aria-expanded="false" id="resourceManager">
						<div
				...
				<li class="nav-item"><a class="nav-link active"
					...
					data-bs-toggle="collapse" data-bs-target="#project-collapse"
					aria-expanded="false" id="resourceManager">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
				...
				<!-- 4) 업무 관리 -->
				<li class="nav-item"><a class="nav-link active"
					data-bs-toggle="collapse" data-bs-target="#works-collapse"
					aria-expanded="false" id="resourceManager">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
						...
						<li
							...
							aria-expanded="false">
								<div class="profile-photo-small">
									<img src="path/to/profile-photo.jpg" alt="프로필 사진"
