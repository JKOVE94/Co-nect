...
public class ProjectDTO {
	...
	private java.sql.Date proj_startdate; //date 날짜 설정
	private java.sql.Date proj_enddate;
	...
	public java.sql.Date getProj_startdate() {
		return proj_startdate;
	}
	
	public void setProj_startdate(java.util.Date date) {
	    if (date != null) {
	        this.proj_startdate = new java.sql.Date(date.getTime());
	    }
	}

	public java.sql.Date getProj_enddate() {
		return proj_enddate;
	}
	public void setProj_enddate(java.util.Date date) {
	    if (date != null) {
	        this.proj_enddate = new java.sql.Date(date.getTime());
	    }
	}
