...
public class TaskDTO {
	...
	private java.sql.Date task_startdate;
	private Date task_deadline;
	private java.sql.Date task_enddate;
	...
	public java.sql.Date getTask_startdate() {
		return task_startdate;
	}
	
	
	public void setTask_startdate(java.util.Date date) {
	    if (date != null) {
	        this.task_startdate = new java.sql.Date(date.getTime());
	    }
	}
	...
	public java.sql.Date getTask_enddate() {
		return task_enddate;
	}
	
	public void setTask_enddate(java.util.Date date) {
	    if (date != null) {
	        this.task_enddate = new java.sql.Date(date.getTime());
	    }
	}
